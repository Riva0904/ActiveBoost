...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        brand:  '0 8px 32px rgba(255,77,0,0.3), 0 2px 8px rgba(255,77,0,0.18)',
      ...
      keyframes: {
        ...
        pulseGlow:    { '0%,100%': { boxShadow: '0 0 0 0 rgba(255,77,0,0)' }, '50%': { boxShadow: '0 0 20px 8px rgba(255,77,0,.25)' } },
